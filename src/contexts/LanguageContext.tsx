...
const translations = {
  es: {
    ...
    'about.music.desc2.after': ', he publicado en redes varias de mis canciones, así como interpretaciones y conciertos en vivo, donde se refleja tanto la diversidad de mis influencias como la evolución de mis habilidades musicales.',
    'about.music.youtube': 'Ver YouTube de SeaSky',
    'about.music.instagram': 'Ver Instagram de SeaSky',
    ...
    'about.sports.desc2': 'Soy fundador y monitor en activo de la asociación sin ánimo de lucro ',
  ...
  en: {
    ...
    'about.music.desc2.after': ', I have published several of my songs on social media, as well as live performances and concerts, reflecting both the diversity of my influences and the evolution of my musical skills.',
    'about.music.youtube': 'View SeaSky YouTube',
    'about.music.instagram': 'View SeaSky Instagram',
    ...
    'about.sports.desc2': 'I am the founder and active instructor of the nonprofit organization ',
    'about.sports.parkour': 'PARKOUR PALAU',
